...
public class SortObjectDateTime implements Comparator<FolloweeMoodEvent>{
     ...
     * @param s1
     * This is a candidate mood event 1
     * @param s2
     * This is a candidate mood event 2
     * @return
     *      return 0 if both the strings are equal, positive if the first string is lexicographically greater, negative if the second string is lexicographically greater
     */
