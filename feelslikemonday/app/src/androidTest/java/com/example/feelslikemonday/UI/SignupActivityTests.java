...
public class SignupActivityTests {
    ...
    public void signUpTest() {
        ...
        solo.enterText((EditText) solo.getView(R.id.signup_username_view), username); // this test will only work once
        solo.enterText((EditText) solo.getView(R.id.signup_password_view), password);
    ...
    public void existingUserSignUpTest() {
        ...
        solo.clickOnView(tv);
        solo.waitForActivity(SignupActivity.class);
        solo.enterText((EditText) solo.getView(R.id.signup_username_view), "user");
        solo.enterText((EditText) solo.getView(R.id.signup_password_view), "12345");
        solo.clickOnButton("Confirm");
